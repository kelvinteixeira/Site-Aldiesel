  ...
  return (
    <Styled.Container>
          ...
          {(props) => (
            <Form onSubmit={props.handleSubmit}>
              <Styled.CardContent>
                <Styled.Title>
                  {" "}
                  <Styled.AiFillCarStyled /> Informações do veiculo
                </Styled.Title>
                <Col xs={7}>
                  <Styled.FormGroupStyled>
                    ...
                    <ErrorMessage name="model">
                      {(msg) => (
                        <Styled.MsgError>Modelo é obrigátorio</Styled.MsgError>
                      )}
                    </ErrorMessage>
                  </Styled.FormGroupStyled>
                </Col>
                  ...
                  <Col>
                    <Styled.FormGroupStyled>
                      ...
                      <ErrorMessage name="licensePlate">
                        {(msg) => (
                          <Styled.MsgError>Placa é obrigátorio</Styled.MsgError>
                        )}
                      </ErrorMessage>
                    </Styled.FormGroupStyled>
                  </Col>
                  <Col>
                    <Styled.FormGroupStyled>
                      ...
                      <ErrorMessage name="year">
                        {(msg) => (
                          <Styled.MsgError>Ano é obrigátorio</Styled.MsgError>
                        )}
                      </ErrorMessage>
                    </Styled.FormGroupStyled>
                  </Col>
                  <Col>
                    <Styled.FormGroupStyled>
                      ...
                      <ErrorMessage name="color">
                        {(msg) => (
                          <Styled.MsgError>Cor é obrigátorio</Styled.MsgError>
                        )}
                      </ErrorMessage>
                    </Styled.FormGroupStyled>
                  </Col>
      ...
      >
        ...
        <Modal.Title>
          {" "}
          <Styled.SubTitle>Cadastrando veiculo...</Styled.SubTitle>
        </Modal.Title>
      </Modal>
    </Styled.Container>
  );
