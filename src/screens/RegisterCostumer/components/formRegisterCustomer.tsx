          ...
          {(props) => (
            <Form onSubmit={props.handleSubmit}>
              <Styled.CardContent>
                <Styled.Title>
                  {" "}
                  <Styled.GoInfoStyled /> Informações do cliente
                </Styled.Title>
                  ...
                  <Col xs={8}>
                    <Styled.FormGroupStyled className="mb-3">
                      ...
                      <ErrorMessage name="name">
                        {(msg) => (
                          <Styled.MsgError>Nome é obrigátorio</Styled.MsgError>
                        )}
                      </ErrorMessage>
                ...
                <Styled.SubTitle>
                  {" "}
                  <Styled.AiOutlineHomeStyled /> Informações do endereço
                </Styled.SubTitle>
                  ...
                  <Col xs={9}>
                    <Styled.FormGroupStyled>
                      ...
                      <ErrorMessage name="street">
                        {(msg) => (
                          <Styled.MsgError>Rua é obrigátorio</Styled.MsgError>
                        )}
                      </ErrorMessage>
                    </Styled.FormGroupStyled>
                  </Col>
